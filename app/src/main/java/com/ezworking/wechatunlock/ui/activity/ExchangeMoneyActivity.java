...
public class ExchangeMoneyActivity extends AppBaseActivity {
    ...
    public void initData() {
        ...
        cashNum =  SharePreferenceUtils.getValueFromSP(aty, "cashNum", "");
        cashRate =  SharePreferenceUtils.getValueFromSP(aty, "cashRate", "");
        ...
        edittext.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
               ...
               final  int  rate= Integer.parseInt(cashRate);
